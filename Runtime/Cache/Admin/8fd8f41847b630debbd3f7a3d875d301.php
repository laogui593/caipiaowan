				...
				<div class="col-sm-12">
					<div class="ibox float-e-margins">
						<div class="ibox-title">
							<h5>重庆时时彩数据采集&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font color="red">已开启采集</font></h5>
							<a class="input-group-btn" href="<?php echo U('Admin/Caiji/addssc');?>"><span class="btn btn-sm btn-success" style="margin-left:20px;">手动添加开奖</span></a>
						</div>
								...
								<table class="table table-striped table-hover table-bordered" style="width:auto;overflow:auto;display:inline-block;">
									...
									<tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
												<td width="50" style="text-align: center;">重庆时时彩</td>

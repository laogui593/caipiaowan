...
<html>
	<head>
		...
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial															<?php if($vo["game"] == 'ssc'): ?>时时彩<?php endif; ?>scale=1.0">
								...
								<form method="get" action="<?php echo U('Admin/Order/index');?>">
									<div class="col-sm-2">
										<select class="form-control" name="game">
											...
											<!--option value="幸运飞艇"  <?php if($game == '幸运飞艇'): ?>selected<?php endif; ?> >北京赛车</option>
											...
											<option value="xyft"  <?php if($game == 'xyft'): ?>selected<?php endif; ?> >急速飞艇</option>
											<option value="ssc"  <?php if($game == 'ssc'): ?>selected<?php endif; ?> >时时彩</option>
									...
									<tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
												...
												<td width="120" style="text-align: center;">
															...
															<?php if($vo["game"] == 'xyft'): ?>急速飞艇<?php endif; ?>													<?php if($vo["game"] == 'jnd28'): ?>螞蟻收益<?php endif; ?>
